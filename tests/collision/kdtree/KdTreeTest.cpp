...
TEST(KdTreeTest, FindsOverlappingPairsAndExcludesNonOverlapping)
{
...
TEST(KdTreeTest, EmptyObjectListProducesNoPairs)
{
...
TEST(KdTreeTest, ManyDisjointObjectsProduceNoPairs)
{
    std::vector<Geometry> objects;
    for (int i = 0; i < 20; ++i)
    {
