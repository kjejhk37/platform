...
[World-of-Tank-imitation-Refactoring](https://github.com/kjejhk37/World-of-Tank-imitation-Refactoring)의 `src/platform` 계층을 독립 저장소로 분리한 것입니다.
...
- `graphics`, `projects` 어느 쪽도 몰라야 합니다(어떤 상위 계층의 헤더도 include하지 않습니다).
...
- 같은 폴더에 "범용 메커니즘"과 "그 메커니즘이 다루는 구체적 데이터"가 섞여 있으면, 메커니즘만 platform으로 가고 데이터는 상위 계층(주로 projects)에 남습니다.
